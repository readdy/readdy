...
TEST_P(TestReactions, TestReactionFactory) {
    kernel->getKernelContext().particleTypeRegistry().registerParticleType("B", 2.0, 1.0);
    kernel->getKernelContext().particleTypeRegistry().registerParticleType("A", 1.0, 1.0);
...
TEST_P(TestReactions, TestConstantNumberOfParticleType) {
    ...
    kernel->getKernelContext().particleTypeRegistry().registerParticleType("A", 1.0, 1.0);
    kernel->getKernelContext().particleTypeRegistry().registerParticleType("B", 1.0, 1.0);
    kernel->getKernelContext().particleTypeRegistry().registerParticleType("AB", 0.0, 1.0);
