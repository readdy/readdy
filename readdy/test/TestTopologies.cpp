...
TEST_P(TestTopologies, AnglePotential) {
    ...
    ctx.particleTypeRegistry().registerParticleType("Topology A", 1.0, 1.0, particle_t::FLAVOR_TOPOLOGY);
    ctx.setBoxSize(10, 10, 10);
    topology_particle_t x_i{0, 0, 0, ctx.particleTypeRegistry().getParticleTypeID("Topology A")};
    topology_particle_t x_j{1, 0, 0, ctx.particleTypeRegistry().getParticleTypeID("Topology A")};
    topology_particle_t x_k{1, 1, 0, ctx.particleTypeRegistry().getParticleTypeID("Topology A")};
