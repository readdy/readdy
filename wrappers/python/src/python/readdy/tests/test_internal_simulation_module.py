...
class TestInternalSimulationModule(unittest.TestCase):
    ...
    def test_potentials(self):
        ...
        self.simulation.registerParticleType("ParticleTypeA", 1.0, 1.0)
        self.simulation.registerParticleType("ParticleTypeB", 3.0, 1.0)
        self.simulation.registerParticleType("ParticleTypeA_internal", 1.0, 1.0)
        self.simulation.registerParticleType("ParticleTypeB_internal", 3.0, 1.0)
        self.simulation.registerPotentialOrder2(pot, "ParticleTypeA", "ParticleTypeB")
        self.simulation.registerHarmonicRepulsionPotential("ParticleTypeA_internal", "ParticleTypeB_internal", 1.0)
