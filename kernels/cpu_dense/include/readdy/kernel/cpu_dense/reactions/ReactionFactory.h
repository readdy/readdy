...
#ifndef READDY_DENSE_CPUREACTIONFACTORY_H
#define READDY_DENSE_CPUREACTIONFACTORY_H
...
public:
    ReactionFactory(CPUKernel *const kernel) : kernel(kernel) {
...
#endif //READDY_DENSE_CPUREACTIONFACTORY_H
