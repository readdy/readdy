...
TEST(TestNeighborListIterator, Adaptive) {
    ...
    kernel::cpu_legacy::nl::NeighborListIterator itBegins(adaptive_data.begin(), adaptive_data.end(), true);
    kernel::cpu_legacy::nl::NeighborListIterator itEnds (adaptive_data.end(), adaptive_data.end(), true);
...
TEST(TestNeighborListIterator, EmptyStatic) {
    ...
    auto itBegins = kernel::cpu_legacy::nl::NeighborListIterator(static_data.begin(), static_data.end(), false);
    auto itEnds = kernel::cpu_legacy::nl::NeighborListIterator(static_data.end(), static_data.end(), false);
...
TEST(TestNeighborListIterator, EmptyDynamic) {
    ...
    auto itBegins = kernel::cpu_legacy::nl::NeighborListIterator(dynamic_data.begin(), dynamic_data.end(), true);
    auto itEnds = kernel::cpu_legacy::nl::NeighborListIterator(dynamic_data.end(), dynamic_data.end(), true);
...
TEST(TestNeighborListIterator, Static) {
    ...
    kernel::cpu_legacy::nl::NeighborListIterator itBegins (static_data.begin(), static_data.end(), false);
    kernel::cpu_legacy::nl::NeighborListIterator itEnds (static_data.end(), static_data.end(), false);
    ...
    {
        auto itBeginsDynamic = kernel::cpu_legacy::nl::NeighborListIterator(expectedNeighbors.begin(), expectedNeighbors.end(), true);
        auto itEndsDynamic = kernel::cpu_legacy::nl::NeighborListIterator(expectedNeighbors.end(), expectedNeighbors.end(), true);
