...
void SCPUUncontrolledApproximation::perform(bool measure, const std::string &measureLabel) {
...
void SCPUGillespie::perform(bool measure, const std::string &measureLabel) {
    util::RAIITimer timer(measure, measureLabel);
    const auto &ctx = kernel->getKernelContext();
