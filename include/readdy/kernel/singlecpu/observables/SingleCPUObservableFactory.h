        ...
        namespace singlecpu {
            namespace observables {
                ...
                public:
                    ...
                    virtual readdy::model::ForcesObservable *createForcesObservable(readdy::model::Kernel* const kernel, unsigned int stride, std::string particleType = std::string()) const override;
                };
            }
        }
    }
