...
# libraries
SET(READDY_IO_LIBRARIES "${READDY_MODEL_LIBRARIES};${HDF5_LIBRARIES};${HDF5_HL_LIBRARIES}" CACHE INTERNAL "IO Libraries")
...
LIST(APPEND READDY_IO_SOURCES "${SOURCES_DIR}/Trajectory.cpp")
